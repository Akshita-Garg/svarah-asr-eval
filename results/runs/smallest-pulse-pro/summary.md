...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| smallest_pulse_pro | yes | 163 | 37 | 82% | 0.1065 | 0.2471 | 0.0000 | 1.084 | 0.220 | 163 | 0.00 |

## Primary comparison — shared subset transcribed by every active backend

Shared successful utterances: **163**. This is the primary direct comparison; coverage above shows that a backend cannot look better by failing on hard samples.

| Backend | Corpus WER | Mean WER | Median WER | Mean RTF | Agg RTF | RTF n |
| --- | --- | --- | --- | --- | --- | --- |
| smallest_pulse_pro | 0.1065 | 0.2471 | 0.0000 | 1.084 | 0.220 | 163 |

## Failures by category

- **smallest_pulse_pro**: http_429=35, network_error=2
