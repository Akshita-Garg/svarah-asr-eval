...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| controlled_whisper_tiny_q4 | no | 0 | 0 | 0% | 0.0000 | 0.0000 | 0.0000 | 0.000 | 0.000 | 0 |  |

## Primary comparison — shared subset transcribed by every active backend

Shared successful utterances: **0**. This is the primary direct comparison; coverage above shows that a backend cannot look better by failing on hard samples.
