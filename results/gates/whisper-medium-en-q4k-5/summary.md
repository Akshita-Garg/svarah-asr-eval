...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| crisp_v0823_whisper_medium_en_q4k | yes | 5 | 0 | 100% | 0.0323 | 0.0252 | 0.0303 | 3.723 | 1.933 | 5 | 1.90 |

## Primary comparison — shared subset transcribed by every active backend

Shared successful utterances: **5**. This is the primary direct comparison; coverage above shows that a backend cannot look better by failing on hard samples.

| Backend | Corpus WER | Mean WER | Median WER | Mean RTF | Agg RTF | RTF n |
| --- | --- | --- | --- | --- | --- | --- |
| crisp_v0823_whisper_medium_en_q4k | 0.0323 | 0.0252 | 0.0303 | 3.723 | 1.933 | 5 |
